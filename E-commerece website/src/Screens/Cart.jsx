      ...
      <div className="max-w-5xl mx-auto p-4 md:p-8">
        ...
        {items.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <Link
              to="/" className="bg-indigo-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-indigo-700 transition-colors">
              Start Shopping
            </Link>
          </div>
        ) : (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="flex-1 text-center sm:text-left">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-500 mb-2 uppercase tracking-tight">
                            {product.brand}
                          </p>
                        </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-fit sticky top-24">
              ...
              <p className="text-xs text-gray-400 mt-4 text-center italic">
                {items[0]?.productData?.returnPolicy ||
